...
from flashdeal.models.order_models import DeliveryInfo, AWBNumber, Basket, ProductVariantOrder
...
@admin.register(ProductVariantOrder)
class ProductVariantOrderAdmin(admin.ModelAdmin):
    pass
